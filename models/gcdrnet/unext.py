...
class UNext_full_resolution(nn.Module):
...
class UNext_full_resolution_padding_L(nn.Module):
...
class UNext_full_resolution_padding_L_py(nn.Module):
    ...
    def __init__(self,  num_classes, input_channels=3, deep_supervision=False,img_size=224, patch_size=16, in_chans=3,  embed_dims=[128, 256, 512],
        ...
        # self.out4 = nn.Sequential(nn.Con2d(64,64,3,1,1),
        #                             nn.BatchNorm2d(64),
        #                             nn.relu(),
        #                             nn.Conv2d(64,3,kernel_size=1))
        # self.out2 = nn.Sequential(nn.Con2d(32,32,3,1,1),
        #                             nn.BatchNorm2d(32),
        #                             nn.relu(),
